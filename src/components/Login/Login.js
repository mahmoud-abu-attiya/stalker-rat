...
class Loginclass extends Component {
  render() {
    ...
    const login = (e) => {
      ...
      axios
        .post("https://stalker-rat-test.herokuapp.com/api/login/", {
      ...
      <div className="container log-in">
        ...
        <form onSubmit={login}>
          ...
          <div className="alert">
            ...
            <div>
              Username or password you entered isn't true, please try again or
          ...
          <a href="/forget-password" className="a-forget">
            Forget password
          </a>
        </form>
      </div>
