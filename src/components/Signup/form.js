...
export default class Form extends Component {
  ...
  completeStepThree = (e) => {
    ...
    if (this.state.password === this.state.confirm) {
      axios
        .post("https://stalker-rat-test.herokuapp.com/api/register", data)
        .then((res) => {
          ...
          <Step className="animate active" id="step-one">
            ...
            <InputContainer>
              <InputWrapper className="form-floating">
                ...
                ></InputField>
                <label htmlFor="floatingFirstname" style={{ color: "white" }}>
                  First Name
                </label>
              </InputWrapper>
              ...
              <InputWrapper className="form-floating">
                ...
                ></InputField>
                <label htmlFor="floatingLastname" style={{ color: "white" }}>
                  Last Name
                </label>
              </InputWrapper>
            </InputContainer>
          ...
          <Step className="animate hidden" id="step-two">
            ...
            <InputContainer>
              <InputWrapper full bottom className="form-floating">
                ...
                ></InputField>
                <label htmlFor="floatingUsername" style={{ color: "white" }}>
                  Username
                </label>
              </InputWrapper>
              ...
              <InputWrapper full bottom className="form-floating">
                ...
                ></InputField>
                <label htmlFor="floatingEmail" style={{ color: "white" }}>
                  Email address
                </label>
              </InputWrapper>
            </InputContainer>
            ...
            <InputContainer>
              <InputWrapper full className="form-floating">
                <InputField
                  ...
                  id="floatingPassword"
                ></InputField>
                <label htmlFor="floatingPassword" style={{ color: "white" }}>
                  Password
                </label>
                <Eye
              ...
              <InputWrapper full bottom className="form-floating">
                <InputField
                  ...
                  id="floatingCongirm"
                ></InputField>
                <label htmlFor="floatingCongirm" style={{ color: "white" }}>
                  Confirm
                </label>
                <Eye
                  className="fa fa-eye-slash"
